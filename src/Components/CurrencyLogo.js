...
import {TweenMax, Power2, gsap} from "gsap/all"
import "./CurrencyLogo.css"
...
class CurrencyLogo extends Component {
    ...
    render() {
        return (
            <div>
                <a href="#">
                <svg version="1.1" className="svg"
                width="195px" height="200px" viewBox="-200 20 650 500" style={{"position":"absolute","top":"-20px", "left":"20px"}}>
                    <g>
                        <path className="logo" fill="none" d="M403.516,147.019H344.68c1.017-7.22,1.655-14.75,1.655-22.753c0-6.076-0.461-11.904-1.117-17.599h58.292
                            ...
                            {/* <path className="path2" stroke="white" strokeWidth="10" d="M503,146 L503, 246" /> */}
                    </g>
                                    </svg>
                </a>
            </div>
